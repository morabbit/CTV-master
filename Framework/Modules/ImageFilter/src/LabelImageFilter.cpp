#include "pch.h"
#include "..\include\LabelImageFilter.h"


LabelImageFilter::LabelImageFilter()
{
}
...
LabelImagePointer LabelImageFilter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBLabelPointer LabelImageFilter::ReadRgbImage(CPCHAR __path)
{
	__clear_var();
...
LabelImagePointer
LabelImageFilter::ReadImage(CPCHAR __path, UCharDicomVO & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	LabelImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
void 
LabelImageFilter::SaveImage(LabelImagePointer __img_ptr,
...
LabelImagePointer
LabelImageFilter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	__clear_var();
	LabelImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_UNSIGNED_CHAR);
