#include "pch.h"
#include "..\include\SliceCBImageFilter.h"


SliceCBImageFilter::SliceCBImageFilter()
{
}
...
SliceCBImagePointer SliceCBImageFilter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBCBSlicerPointer SliceCBImageFilter::ReadRgbImage(CPCHAR __path)
{
	__file_path__ = __path;
...
SliceCBImagePointer 
SliceCBImageFilter::ReadImage(CPCHAR __path, UShortDicomVO & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	SliceCBImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
SliceCBImagePointer 
SliceCBImageFilter::ImportImage(
	PUSHORT __buf, ImageHeader __hd, UINT & __bufLenth)
{
	return this->ImportBufferToImage(__buf, __hd, __bufLenth);
}

void 
SliceCBImageFilter::SaveImage(SliceCBImagePointer __img_ptr, 
...
SliceCBImagePointer
SliceCBImageFilter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	SliceCBImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_UNSIGNED_SHORT);
