#include "pch.h"
#include "..\include\SliceLabelImageFilter.h"


SliceLabelImageFilter::SliceLabelImageFilter()
{
}
...
SliceLabelImagePointer SliceLabelImageFilter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBSlicerLabelPointer SliceLabelImageFilter::ReadRgbImage(CPCHAR __path)
{
	__file_path__ = __path;
...
SliceLabelImagePointer 
SliceLabelImageFilter::ReadImage(CPCHAR __path, UCharDicomVO & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	SliceLabelImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
SliceLabelImagePointer 
SliceLabelImageFilter::ImportImage(
	PUCHAR __buf, ImageHeader __hd, UINT & __bufLenth)
{
	return this->ImportBufferToImage(__buf, __hd, __bufLenth);
}

void 
SliceLabelImageFilter::SaveImage(SliceLabelImagePointer __img_ptr, 
...
SliceLabelImagePointer
SliceLabelImageFilter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	__clear_var();
	SliceLabelImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_UNSIGNED_CHAR);
