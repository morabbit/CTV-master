#include "pch.h"
#include "..\include\SliceFloatImageFilter.h"


SliceFloatImageFilter::SliceFloatImageFilter()
{
}
...
SliceFloatImagePointer SliceFloatImageFilter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBSliceFloatPointer SliceFloatImageFilter::ReadRgbImage(CPCHAR __path)
{
	__file_path__ = __path;
...
SliceFloatImagePointer 
SliceFloatImageFilter::ReadImage(CPCHAR __path, FloatDicomValue & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	SliceFloatImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
SliceFloatImagePointer 
SliceFloatImageFilter::ImportImage(
	PFLOAT __buf, ImageHeader __hd, UINT & __bufLenth)
{
	return this->ImportBufferToImage(__buf, __hd, __bufLenth);
}

void
SliceFloatImageFilter::SaveImage(
	SliceFloatImagePointer __img_ptr, CPCHAR __path, CPCHAR __name, CPCHAR __extent)
{
	__clear_var();
...
SliceFloatImagePointer 
SliceFloatImageFilter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	__clear_var();
	SliceFloatImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_FLOAT);
