#include "pch.h"
#include "..\include\SliceCharImageFilter.h"



SliceCharImageFileter::SliceCharImageFileter()
{
}
...
SliceCharImagePointer SliceCharImageFileter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBSlicerCharPointer SliceCharImageFileter::ReadRgbImage(CPCHAR __path)
{
	__file_path__ = __path;
...
SliceCharImagePointer 
SliceCharImageFileter::ReadImage(CPCHAR __path, CharDicomValue & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	SliceCharImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
SliceCharImagePointer 
SliceCharImageFileter::ImportImage(
	PCHAR __buf, ImageHeader __hd, UINT & __bufLenth)
{
	return this->ImportBufferToImage(__buf, __hd, __bufLenth);
}

void 
SliceCharImageFileter::SaveImage(SliceCharImagePointer __img_ptr, 
...
SliceCharImagePointer
SliceCharImageFileter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	__clear_var();
	SliceCharImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_CHAR);
