#include "pch.h"
#include "..\include\FloatImageFilter.h"


FloatImageFilter::FloatImageFilter()
{
}
...
FloatImagePointer FloatImageFilter::ReadImage(CPCHAR __path)
{
	__clear_var();
...
RGBFloatPointer FloatImageFilter::ReadRgbImage(CPCHAR __path)
{
	__clear_var();
...
FloatImagePointer
FloatImageFilter::ReadImage(CPCHAR __path, ShortDicomVO & __dicom_vo)
{
	load_image __ld_img;
	ImageHeader _img_head;
	__file_path__ = __path;
	__parse_path();
	FloatImagePointer __img = __read_sigle_file_with_head(&_img_head, &__ld_img, true);
...
FloatImagePointer
FloatImageFilter::ImportImage(PFLOAT __buf, ImageHeader __hd, UINT & __bufLenth)
{
	return this->ImportBufferToImage(__buf, __hd, __bufLenth);
}

void 
FloatImageFilter::SaveImage(FloatImagePointer __img_ptr,
...
FloatImagePointer
FloatImageFilter::VtkImageToItkImage(vtkSmartPointer<vtkDataSet> __itk_img)
{
	__clear_var();
	FloatImagePointer __img_ptr = __VtkImageToItkImage(__itk_img, VTK_FLOAT);
